...
const s: Record<string, React.CSSProperties> = {
  ...
  logoIcon:      { width: 38, height: 38, borderRadius: 10, background: 'linear-gradient(135deg, #1d4ed8 0%, #3b82f6 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 4px 12px rgba(59,130,246,0.35)' },
  ...
  navItemActive: { background: 'rgba(59,130,246,0.15)' },
  activeBar:     { position: 'absolute', left: 0, top: '18%', bottom: '18%', width: 3, borderRadius: 10, background: '#3b82f6' },
